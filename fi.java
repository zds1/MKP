...
public class fi {
	...
	public static void main(String[] args) {
		File file = new File("C:\\Users\\14651\\Desktop\\28个商品10个约束.txt");// 我的txt文本存放目录，根据自己的路径修改即可
		int[][][] gg = s(file);		
	...
	public static int[][][] s(File file) {
		...
		try {
			...
			givevalue = Integer.parseInt(h[2]); // 读取价格
			 splitss = new String[Integer.parseInt(h[1]) + 2]; // 除去第一行剩余的行数
			 sp = new String[Integer.parseInt(h[0])]; // 除去第一行有多少行
